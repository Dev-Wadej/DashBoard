...
import { RiNotification3Line, RiProfileLine } from 'react-icons/ri';
...
const NavButton: React.FC<NavButtonInterface> =({title,customFunc,icon,color,dotColor})=>(
...
const Navbar = () => {
  ...
  const {activeMenu,setActiveMenu,isClicked,setIsClicked,handleClick, screenSize,setScreenSize}= useStateContext()
      ...
      useEffect(() => {
        ...
        if(screenSize ===null || screenSize===undefined)return
        if(screenSize <= 900){
          setActiveMenu?.(false)
        }
        else{
         ...
         <Tooltip title='Profile' placement='bottom'>
           ...
           >
             ...
             <p>
               ...
               <span className='text-gray-400 font-bold ml-1 text-14'>Joshua</span>
             </p>
